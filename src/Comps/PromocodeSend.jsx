      ...
      <div className="container-fluid c-color pt-30 pb-30">
        <div className="container-xxl ptt">
          <div className="row promo-code-box">
            <div className="col-md-6">
              <div className="d-flex align-items-center justify-content-between ">
                <div
                  ...
                  className="promo-input d-flex align-items-center justify-content-between"
                >
                  <input type="text" placeholder="Промокод" />
                  <img
                    style={{ width: "46px", heigth: "46px" }}
            ...
            <MDSum selected={selected}/>
            <SXSum selected={selected}/>
          </div>
        </div>
      </div>
    </>
